...
import com.officiallysp.alchemicalexcellence.item.ChargedMysticalStoneItem;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency x for procedure AEInfuserInfuse!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency y for procedure AEInfuserInfuse!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency z for procedure AEInfuserInfuse!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency world for procedure AEInfuserInfuse!");
			return;
		}
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(ChargedMysticalStoneItem.block, (int) (1));
