	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency x for procedure AEBinderUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency y for procedure AEBinderUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency z for procedure AEBinderUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AlchemicalExcellenceMod.LOGGER.warn("Failed to load dependency world for procedure AEBinderUpdateTick!");
			return;
		}
		...
		if ((((new Object() {
		...
		}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (10))) < 1) && (((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(AEFragmentItem.block, (int) (1)).getItem())
				&& (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(AEFragmentItem.block, (int) (1))
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								...
								.getItem() == new ItemStack(AEFragmentItem.block, (int) (1)).getItem()) && (((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
										if (_ent != null) {
													...
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														...
														.getItem() == new ItemStack(AEFragmentItem.block, (int) (1)).getItem()) && (((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																...
																.getItem() == new ItemStack(AEFragmentItem.block, (int) (1)).getItem())
																&& (((new Object() {
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
																		TileEntity _ent = world.getTileEntity(pos);
																		...
																		&& (((new Object() {
																			public ItemStack getItemStack(BlockPos pos, int sltid) {
																				...
																				.getItem() == new ItemStack(AEFragmentItem.block, (int) (1))
																						.getItem())
																				&& ((new Object() {
																					public ItemStack getItemStack(BlockPos pos, int sltid) {
																						AtomicReference<ItemStack> _retval = new AtomicReference<>(
		...
		if ((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(AEShardItem.block, (int) (1))
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(AEShardItem.block, (int) (1))
								.getItem()) && (((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
										...
										.getItem() == new ItemStack(AEShardItem.block, (int) (1)).getItem()) && (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
												TileEntity _ent = world.getTileEntity(pos);
												if (_ent != null) {
													...
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														...
														.getItem() == new ItemStack(AEShardItem.block, (int) (1)).getItem()) && (((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																...
																.getItem() == new ItemStack(AEShardItem.block, (int) (1)).getItem())
																&& (((new Object() {
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
																		TileEntity _ent = world.getTileEntity(pos);
																			...
																			public ItemStack getItemStack(BlockPos pos, int sltid) {
																				...
																				&& ((new Object() {
																					public ItemStack getItemStack(BlockPos pos, int sltid) {
																						...
																						.getItem() == new ItemStack(AEShardItem.block, (int) (1))
																								.getItem())))))))))))) {
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
				if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (10);
					final ItemStack _setstack = new ItemStack(AEBlockBlock.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(IWorld world, BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
