...
package com.officiallysp.alchemicalexcellence.world.biome;
...
import com.officiallysp.alchemicalexcellence.block.AEPearldirtBlock;
import com.officiallysp.alchemicalexcellence.block.AEPearlGrassBlock;
...
public class AEBiomeBiome extends AlchemicalExcellenceModElements.ModElement {
	public static Biome biome;
	public AEBiomeBiome(AlchemicalExcellenceModElements instance) {
		super(instance, 46);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						...
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("ambient.underwater.loop.additions.rare")))
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(AEPearlGrassBlock.block.getDefaultState(),
								AEPearldirtBlock.block.getDefaultState(), AEPearldirtBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("alchemical_excellence:ae_biome"));
			}
		}
	}
	@Override
