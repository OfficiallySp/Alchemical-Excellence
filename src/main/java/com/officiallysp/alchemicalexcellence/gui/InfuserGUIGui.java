...
import com.officiallysp.alchemicalexcellence.procedures.AEInfuserInfuseProcedure;
...
public class InfuserGUIGui extends AlchemicalExcellenceModElements.ModElement {
		...
		if (buttonID == 0) {
			{
				...
				AEInfuserInfuseProcedure.executeProcedure($_dependencies);
			}
		}
	}
