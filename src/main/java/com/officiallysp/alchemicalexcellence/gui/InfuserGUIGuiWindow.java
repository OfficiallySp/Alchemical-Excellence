...
public class InfuserGUIGuiWindow extends ContainerScreen<InfuserGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Infuser", 69, 34, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 69, this.guiTop + 52, 36, 20, new StringTextComponent("Infuse"), e -> {
			if (true) {
				AlchemicalExcellenceMod.PACKET_HANDLER.sendToServer(new InfuserGUIGui.ButtonPressedMessage(0, x, y, z));
