 ...
 *
 *    Keep the AlchemicalExcellenceModElements object in this class and all calls to this object
...
public class AlchemicalExcellenceMod {
	...
	public AlchemicalExcellenceModElements elements;
	public AlchemicalExcellenceMod() {
		elements = new AlchemicalExcellenceModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new AlchemicalExcellenceModFMLBusEvents(this));
	}
	...
	private static class AlchemicalExcellenceModFMLBusEvents {
		private final AlchemicalExcellenceMod parent;
		AlchemicalExcellenceModFMLBusEvents(AlchemicalExcellenceMod parent) {
			this.parent = parent;
		}
