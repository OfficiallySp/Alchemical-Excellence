...
public class NullitestoneampItem extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:nullitestoneamp")
	public static final Item block = null;
	public NullitestoneampItem(AlchemicalExcellenceModElements instance) {
		super(instance, 37);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("nullitestoneamp");
		}
