...
public class NullMultitoolItem extends AlchemicalExcellenceModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("The embodiment of nothingness"));
			}
		}.setRegistryName("null_multitool"));
	}
