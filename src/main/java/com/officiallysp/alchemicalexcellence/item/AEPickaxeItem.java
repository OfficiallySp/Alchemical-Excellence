...
public class AEPickaxeItem extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pickaxe")
	public static final Item block = null;
	public AEPickaxeItem(AlchemicalExcellenceModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Gives a small chance to activate Super Repair"));
				list.add(new StringTextComponent("Fully Repairs the pickaxe when activated"));
			}
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					AEPickaxeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("ae_pickaxe"));
	}
}
