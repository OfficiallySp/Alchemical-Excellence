...
public class AEPearlwoodplankBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pearlwoodplank")
	public static final Block block = null;
	public AEPearlwoodplankBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ae_pearlwoodplank");
		}
