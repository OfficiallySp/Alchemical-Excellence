...
public class AEPearlwoodstairsBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pearlwoodstairs")
	public static final Block block = null;
	public AEPearlwoodstairsBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ae_pearlwoodstairs");
		}
