...
import com.officiallysp.alchemicalexcellence.gui.InfuserGUIGui;
...
public class AEInfuserBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_infuser")
	public static final Block block = null;
	@ObjectHolder("alchemical_excellence:ae_infuser")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AEInfuserBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 5);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("ae_infuser"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("ae_infuser");
		}
