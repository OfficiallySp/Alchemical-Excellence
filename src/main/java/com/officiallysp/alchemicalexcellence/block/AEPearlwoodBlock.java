...
public class AEPearlwoodBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pearlwood")
	public static final Block block = null;
	public AEPearlwoodBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 23);
	}
