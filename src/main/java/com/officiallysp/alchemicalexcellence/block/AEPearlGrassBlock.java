...
public class AEPearlGrassBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pearlgrass")
	public static final Block block = null;
	public AEPearlGrassBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 20);
	}
