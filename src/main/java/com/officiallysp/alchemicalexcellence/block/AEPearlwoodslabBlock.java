...
public class AEPearlwoodslabBlock extends AlchemicalExcellenceModElements.ModElement {
	@ObjectHolder("alchemical_excellence:ae_pearlwoodslab")
	public static final Block block = null;
	public AEPearlwoodslabBlock(AlchemicalExcellenceModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ae_pearlwoodslab");
		}
